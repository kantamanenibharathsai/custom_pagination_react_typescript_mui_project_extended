...
export const products : EachProuct[] = [
  {
    productId: 1,
    title: "iPhone 9",
  ...
  },
  {
    ...
    description:
      "Style and speed. Stand out on HD vproductIdeo calls backed by Studio Mics. Capture productIdeas on the vibrant touchscreen.",
    price: 1499,
  ...
  },
  {
    ...
    description:
      "L'Or̩al Paris introduces Hyaluron Expert Replumping Serum formulated with 1.5% Hyaluronic AcproductId",
    price: 19,
  ...
  },
  {
    ...
    description:
      "Dermive Oil Free Moisturizer with SPF 20 is specifically formulated with ceramproductIdes, hyaluronic acproductId & sunscreen.",
    price: 40,
  ...
  },
  {
    ...
    description:
      "Product name: rorec collagen hyaluronic acproductId white face serum riceNet weight: 15 m",
    price: 46,
  ...
  },
  {
    ...
    description:
      "Fair & Clear is Pakistan's only pure Freckle cream which helpsfade Freckles, Darkspots and pigments. Mercury level is 0%, so there are no sproductIde effects.",
    price: 70,
